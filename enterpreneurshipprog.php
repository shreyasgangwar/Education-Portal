...
<section class="abt2">
	<h1 class="feature_heading2 educot-logo" >Educot's Entrepreneurial Program </h1>
	<div style="margin:20px;">
        <h3 class="feature_heading display-6">Designed especially for the students who have DREAM/IDEA but lack the knowledge and guidance to execute and implement it.  </h3>
        <h4 class="feature_heading display-6">Through the program, we will lead your idea to success. <br>
  You will get desired skills to make a mark in the world. <br>
</h4>
        <h5 class="feature_faq mb-4 " style="color:#424242">Things you will learn on your path: <br>
            	Technical skills <br>
            ...
            <ul style="list-style-type:disc">
                ...
                <li>Market Domain For Product</li>
                <li>Developmente</li>
                <li>Product Enhancement</li>
                <li>Product Improvisation</li>
                <li>Strategy Development</li>
            </ul>  
            	Working on projects<br>
            	Working on tasks<br>
            	Developing idea into a business model<br> 
            	How to pitch your idea to investors<br>
            	Consultancy<br>
        </h5>
        <h4 class="feature_heading display-6">
            For More Details Contact on: 8979538455( WhatsApp )<br></h4>
        </div>
  <div style="margin:20px;">
