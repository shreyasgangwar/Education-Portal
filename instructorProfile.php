...
if($r3!=null) {
    ...
    if(array_key_exists('submit', $_POST))
    {
        ...
        else if($filesize >1000000)
        {
            ...
            $pass=md5($pass);
            $id2=$r3['id'];
            $query="UPDATE instructor SET ( name='$name' , dob='$dob', college='$coll', contact='$contact',image_id='$imageid', email='$email', password='$pass') WHERE instructor_id= '$id2'";
        ...
        <div class="col-md-3">
            <div class="profile-sidebar">
                ...
                <div class="profile-userpic" align="center">
                    <img class="rounded-circle media-object" src="<?php echo("$result1");?>" style="height: 20%">
                </div>
                <!-- END SIDEBAR USERPIC -->
                <!-- SIDEBAR USER TITLE -->
