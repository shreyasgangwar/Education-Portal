...
<body>
	...
	<section class="contact">
		...
		<h1 class='elegantshadow'>Jump 2 school</h1>
		<div class="row">
		<div class="col-sm-6">
<ul class="featured-list2">
          <li class="mb-5">
		  
            <div class="featured-list-icon2 circle">
              <span class="icon icon-hour-glass"><i class="material-icons md-36" style="color:#ffffff">call</i></span>
            </div>
			<div class="contact-p">
              <p class="featured-list-icon-text2 mb-0"><strong>9828093172, 9891619489</strong></p>
            </div>
            ...
            <div class="featured-list-icon2 circle">
              <span class="icon icon-hour-glass"><i class="material-icons md-36" style="color:#ffffff">location_on</i></span>
            </div>
			<div class="contact-p">
              <p class="featured-list-icon-text2 mb-0"><strong>Kdp grand Savana, B-block, 1103, Ghaziabad, Uttar Pradesh</strong></p>
            </div>
          </li>
		  ...
		  <li class="mb-5">
            ...
            <div class="featured-list-icon2 circle">
              <span class="icon icon-hour-glass"><i class="material-icons md-36" style="color:#ffffff">email</i></span>
            </div>
			<div class="contact-p">
              <p class="featured-list-icon-text2 mb-0"><strong>enquiry@educot.com</strong></p>
            </div>
          </li>
	  ...
	  <div class="embed-responsive embed-responsive-16by9">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1320.9885933651017!2d77.4199318!3d28.702809299999995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cf0e2fc9bc1bd%3A0x66b750abf53d51d6!2sKDP+GRAND+SAVANNA!5e0!3m2!1sen!2sin!4v1515022993285" width="400" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
		</div>
	 </div>
    </div>
	</section>
