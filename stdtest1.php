...
<html>
    ...
    <body >
        ...
        <div id="container">
            <div class="header">
                <img style="margin:10px 2px 2px 10px;float:left;" height="80" width="100" src="images/vlogo.png" alt="OES"/><h3 class="headtext"> &nbsp;SRM Exam Portal </h3><h4 style="color:#ffffff;text-align:center;margin:0 0 5px 5px;"><i></i></h4>
            </div>
            ...
            <div id="footer">
                <p style="font-size:70%;color:#ffffff;"> Developed By-<b>Advanced Tribe</b><br/> </p>
            </div>
        </div>
    </body>
</html>
