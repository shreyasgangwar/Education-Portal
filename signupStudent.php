...
if(array_key_exists('submit_1', $_POST)){
    ...
    else if ($link->query("SELECT * FROM user WHERE email='$mail' student='1'"))
    {
                 ...
                 <li class="nav-item active dropdown">
                  ...
                  <li class="nav-item active">
                      ...
                      <a class="nav-link divider" href="contactus.php"><i class="fa fa-envelope" aria-hidden="true"></i> Contact Us</a>
                        ...
                        <button class="btn btn-primary btn-sm" type="button"><?php if(null!=$_SESSION){ echo(' '.$_SESSION['email']);} else{ echo ('Login/Sign-up');} ?></button>
          </div>
...
<div class="container">
        ...
        <div class="student-signup-form">
        	<div class="row">
			    ...
			    <div class="col-md-6">
                                ...
                                <input type="text" id="dob" name="dob" class="form-control sign-input" placeholder="Date of Birth" pattern="(0?[1-9]|[12][0-9]|3[01])/(0?[1-9]|1[012])/\d{4}" title="correct DD/MM/YYYY" required>
		        <label for="inputDOB" class="sr-only">DD/MM/YYYY</label>
			    </div>
			    <div class="col-md-6">
                                <input type="email" id="mail" name="mail" class="form-control sign-input" placeholder="Email address" pattern="[a-z0-9._]+@[a-z0-9]+\.[a-z]{2,3}" title="someone@example.com" required><!----> 
		    ...
		    <div class="row">
			    ...
			    <div class="col-md-6">
                                <input type="text" id="contact" name="contact" class="form-control sign-input" placeholder="Contact no." pattern="[0-9]{10,10}" title="0123456789" ><!---->
        		<label for="inputCont" class="sr-only">Contact Number</label>
			    </div>
			    <div class="col-md-6">
                                <input type="text" id="alt_contact" name="alt_contact" class="form-control sign-input" placeholder="Alternate Contact no." pattern="[0-9]{10,10}" title="0123456789" ><!---->
 ...
 <div class="fileupload fileupload-new" data-provides="fileupload">
    ...
    <a href="#" class="close fileupload-exists" data-dismiss="fileupload" style="float: none">×</a>
        ...
        <div><p>Already registered? <button class="toggleForms btn btn-danger btn-sm">Sign in</button></p></div>
