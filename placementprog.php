<html>
    <head>
        <title>Educot-Placement program</title>
...
<section class="abt2">
	<h1 class="feature_heading2 educot-logo" >Educot’s Placement Preparation Program</h1>
	<div style="margin:20px;">
        <h3 class="feature_heading display-6">Don't let any stone unturned join now and prepare for future. Prepare for your placements and other competitive exams </h3>
        <h5 class="feature_faq mb-4 " style="color:#424242">Features of Educot's Placement Program: <br>
          •  1 Month(June-July) Comprehensive Program.<br>
          •  Aptitude test (2 major and 3 minor tests) - every week.<br>
          •  Technical test (2 major and 3 minor tests) - every week.<br>
•  Online Group discussion (5-6 persons) - every alt. week.<br>
•  3 mock interviews.<br>
•  A book to guide yourself for interview.<br>
•  Consultancy before the interviews.<br>
•  Progress report analysis of every test, interview and GD<br>
        </h5>
        <h4 class="feature_heading display-6">ENROLLMENT FEES – Rs. 999-/ only<br>
