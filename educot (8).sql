...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 15, 2018 at 11:53 PM
...
CREATE TABLE `course` (
  ...
  `About_course` varchar(300) NOT NULL,
...
INSERT INTO `course` (`Course_id`, `Course_title`, `About_course`, `Audience`, `instructor_id`, `Level`, `Language`, `Hours`, `Link`) VALUES
(1, 'Xbox', 'nnxqoixoiwojojxajpiji', 'children', 1, 'easy', 'english', 2, 'nlnansdipia donoandnnadnnsandonosandn'),
(2, 'Play station', 'bkKUBUU', 'OUUOSHUHDOUHUOHUO', 1, 'adv', 'eng', 34, 'IBNSNDAHN;ASDNNN'),
(3, 'c++', 'INTERACTIVE', 'DHIAHI', 1, 'begin', 'eng', 19, 'NOAJDOOJQD9U2DPU92UOUH2OUHD9-1'),
(4, 'OJNASNDJNASKNDKNKNKN', 'UUHSUHAIHD', '', 1, 'begin', 'eng', 0, '');
...
INSERT INTO `courseapplication` (`id`, `course_id`, `student_id`, `instructor_id`) VALUES
(1, 1, 28, 1),
(2, 2, 28, 1),
(3, 4, 28, 1),
(4, 4, 27, 1);
...
(1, 'Satyam', '2017-01-01', 2147483647, 'saa@g.com', 'srmdjnjs', 'sdakk', '0f2cdafc6b1adf94892b17f355bd9110', 65);
...
INSERT INTO `jobapplications` (`id`, `job_id`, `student_id`) VALUES
(2, 20, 26),
(3, 21, 26),
(4, 6, 26),
(5, 6, 28),
...
INSERT INTO `resume` (`id`, `resume_name`, `resume_path`) VALUES
(1, 'j2sw.jpg', 'resume/j2sw.jpg'),
(5, '', 'resume/'),
(6, '', 'resume/'),
(7, '', 'resume/'),
(8, '', 'resume/'),
(9, 'download.jpg', 'resume/download.jpg'),
(10, 'j2sw.jpg', 'resume/j2sw.jpg'),
(11, 'educot.sql', 'resume/educot.sql');
...
(28, 'radha', 'Krishna', '2018-03-10', 'GURUKUK', 3, NULL, NULL, NULL, 'r@g.com', '9058113737', '9412464391', NULL, 369, NULL, NULL, '0f2cdafc6b1adf94892b17f355bd9110', 1),
...
--
-- Indexes for table `courseapplication`
--
...
--
-- AUTO_INCREMENT for table `courseapplication`
--
ALTER TABLE `courseapplication`
