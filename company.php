...
if(!isset($_SESSION['email']))
{
    ...
    if(isset($_POST['submit']))
    {
        ...
        if ($link->query($sql) === TRUE)
        {
            if($selected_val =='no'){
                ...
                $q=mysqli_fetch_assoc(mysqli_query($link,"SELECT Subject_id FROM companyrequirement WHERE (company_id='$result3' AND domain_name='".$_POST['hiringFor']."')"));
                $q=$q['Subject_id'];
                header("location: examDetail.php?query=$q");
            }
        }
        else
        {
    ...
    if($_SERVER['REQUEST_METHOD'] == "GET" && (isset($_GET['delete'])))
    {
        ...
        $sql1=mysqli_query($link,"DELETE FROM `companyrequirement` WHERE `companyrequirement`.`Subject_id` = '$parameter'");
        if(sql1)
    ...
    <head>
        ...
        <title><?php echo($result4['company_name']); ?></title>
    ...
    <nav class="navbar fixed-top navbar-toggleable-md navbar-inverse">
        ...
        <div class="container">
            <div class="row">
                <a class="navbar-brand" href="company.php"><img class="img-responsive" src="images/logo.png" alt="logo"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active">
                    ...
                    <a class="nav-link" href="company.php"><i class="fa fa-home" aria-hidden="true"></i> Home<span class="sr-only">(current)</span></a>
    ...
    <div class="container" style="margin-top: 10%">
        ...
        while($product = mysqli_fetch_assoc($featured)):
            ...
            $takeExam=$product['takeExam'];
            $cid=$product['company_id'];
            $subid=$product['Subject_id'];
            ?>
            <div class="container" >
                <div class="job-card">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="apply-post">
                                ...
                                <br/>
                                <?php if($takeExam=='yes'){
                                    $exam_id=mysqli_fetch_assoc(mysqli_query($link,"SELECT Exam_id FROM exam WHERE (Subject_id='$subid' AND Company_tcid='$cid')"));
                                    $exam_id=$exam_id['Exam_id']; ?>
                                <a class="btn btn-outline-danger" href="questionDetail.php?id=<?php echo("$exam_id");?>" role="button">Edit Exam</a>
                                <form method="get" action="company.php"><a type="submit" href="company.php?delete=<?php echo"$subid";?>" name="delete" class="btn btn-outline-danger">Remove</a></form>
                                <?php }else{ ?>
                                <form method="get" action="company.php"><a type="submit" href="company.php?delete=<?php echo"$subid";?>" name="delete" class="btn btn-outline-danger">Remove</a></form>
                                <?php }?>
                            </div>
