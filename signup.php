    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	  ...
	  <style>
		...
		body{
  		...
  		background:linear-gradient(to top left, #44484b 0%, #ffffff 100%);
...
<body>
     ...
     <nav class="navbar fixed-top navbar-toggleable-md navbar-inverse">
      ...
      <section class="signup-form-container">
			...
			<br/><br/><br/>
				<a class="btn btn-primary btn-lg" href="signupStudent.php" role="button">Sign Up to gain knowledge</a><br/><br/>
				<br/>
				<a class="btn btn-primary btn-lg" href="signupJob.php" role="button">Sign Up to find job</a>
			</div>
	</section>
	  <br/>
