...
<body>
      ...
      <div class="container">
      <div class="row">
          <a class="navbar-brand" href="index.php.php"><img class="img-responsive" src="images/logo.png" alt="logo"></a>
  ...
  <div class="row">
    <div class="col-md-12">
      <textarea class="form-control" rows="1" placeholder="Company Objective and Description*"></textarea>
    </div>
  </div>
