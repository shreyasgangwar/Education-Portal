...
<body>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <ul class="navbar-nav ml-auto">
                 ...
                 <li class="nav-item active dropdown">
				  ...
				  <button class="btn btn-primary btn-sm" type="button">Login/SignUp</button>
			...
			<div class="col-sm-12 col-md-9">
				<div class="job-card">
					<div class="row">
						<div class="col-sm-8">
							<div>
								<img src="images/logo2" style="float:left; height:100px;  border-radius: 50%;">
								<h3 style="padding:5px; margin:5px;">Company Name</h3>
								<h6 style="padding:5px; margin:5px;">Description</h6>
							</div><br/><hr>
							<h6 style="padding:5px; margin:5px; color: #F44336; float:left;"><i class="fa fa-briefcase" aria-hidden="true"></i> Experience</h6>
							<h6 style="padding:5px; margin:5px; color: #F44336; float:left;"><i class="fa fa-money" aria-hidden="true"></i> Salary</h6>
						</div>
						<div class="col-sm-4">
							<div class="apply-post">
							<h4>Post available</h4>
							<h6>Joining/Duration</h6><br/>
							<a class="btn btn-outline-danger" href="signupJob.php" role="button">Apply</a></div>
							</div>
					</div>
				</div>
  		<br/>
  		...
  		<div class="job-card">
					<div class="row">
						...
						<div class="col-sm-4">
							...
							<h4>Post available</h4>
							<h6>Joining/Duration</h6><br/>
							<button type="button" class="btn btn-outline-danger">Apply</button></div>
							</div>
					</div>
				</div>
  		<br/>
  ...
  <div class="card-block">
  	<img src="images/abt2" style="height:100px; width:100px; border-radius: 50%; border-color:#FF5252; border-style: solid;" class="card-img-top">
