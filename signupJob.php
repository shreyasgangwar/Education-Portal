...
<section class="login-section">
            ...
            <div class="col-md-12 text-center signup2">
                ...
                <form method="post" class="form-signin" id = "signUpForm" enctype="multipart/form-data">
                    ...
                    <div class="job-signup-form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input type="Date" id="dob" name="dob" class="form-control sign-input" placeholder="Date of Birth" required autofocus>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="number" id="skills" name="father_no" class="form-control sign-input" placeholder=" Parents Contact no." required autofocus>
                                <label for="inputContact" class="sr-only">Contact no.</label>
                            </div>
                        </div>
    ...
    <input type="file"  name="Upload"/>
                    ...
                    <div><br/><p>Already registered? <button id="myButton" class="toggleForms btn btn-danger btn-sm">Sign in</button></p></div>
                </form>
            </div>
        </div>
