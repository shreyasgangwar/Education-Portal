   ...
   header("location: login.php");
    ...
    if(array_key_exists('submit_1' , $_POST))
    {
        ...
        if(mysqli_num_rows($result) != 0){
            ...
            $query="INSERT INTO `exam` (`Exam_id`, `Exam_name`, `subject`, `Exam_description`, `Exam_date`, `Exam_time`, `Exam_from`, `Exam_to`, `Exam_duration`, `Exam_totalQuestion`, `Exam_attempted_student`, `Exam_code`, `Company_tcid` , `passing_criteria`,`Subject_id`) VALUES (NULL, '$name', '$exam_for', '$desc', '$v_from', '$v_from', '$v_from', '$v_to', '$dur', '$quest', 0, '$code', '$Company_tcid' , '$passing','$subjectid')";
            $result=mysqli_query($link, $query);
            if(!$result) {
...
?>
    <div class="container login-section card" style="background-color: #ffffff">
        ...
        <br>
       <div align="middle">
           <form method="post"><button type="submit" name="manage" class="btn btn-outline-danger" value="1"><h3>Upload Manually</h3></button></form>
       </div>
        <br>
        <br><br>
    </div>
                    ...
                    <form method="post" id = "signUpForm" class="form-signin" enctype="multipart/form-data">
                        ...
                        <div class="exam_detail_form">
                            <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <h5 align="justify"> Post Offered </h5>
                                    </div>

                                    <div class="col-md-6">
                                        <input type="text" id="exam_for" name="exam_for" class="form-control sign-input" placeholder="Post Offered" required>
                                        <label for="inputEFor" class="sr-only">Post Offered</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
